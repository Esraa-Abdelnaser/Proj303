    ...
    <section class="page-section" id="contact">
        <div class="container">
            ...
            <div class="row align-items-stretch mb-5">
                <div class="col-md-5">
                    <!-- ده فورم للساين اب -->
                    <form id="contactForm1" action="/store_customers" method="POST">
                        {{csrf_field()}}
                        <div class="text-center">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" minlength="1" maxlength="20" class="form-control" id="name" type="text" placeholder="Your Name *" required="required" data-validation-required-message="Please enter your Name." />
                ...
                <div class="col-md-5">
                    <form id="contactForm1" action="/signin" method="POST">
                        {{csrf_field()}}
                        <div class="text-center">
                            <h2 class="section-heading text-uppercase" style="margin-top:80px">SignIn</h2>
                        </div>
                        <div class="form-group">
                            <input name="name2" minlength="1" maxlength="20" class="form-control" id="name" type="text" placeholder="Your Name *" required="required" data-validation-required-message="Please enter your Name." />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="form-group">
